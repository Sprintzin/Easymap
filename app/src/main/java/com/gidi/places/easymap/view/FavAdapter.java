...
/**
 * Adapter for favorites fragment
 */
public class FavAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        long id = cursor.getLong(cursor.getColumnIndex(PlacesContract.Favorites.ID));
        String address;
        ...
        double lat = cursor.getDouble(cursor.getColumnIndex(PlacesContract.Favorites.LAT));
        double lng = cursor.getDouble(cursor.getColumnIndex(PlacesContract.Favorites.LNG));
        String icon = cursor.getString(cursor.getColumnIndex(PlacesContract.Favorites.ICON));
